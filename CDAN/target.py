...
#
# #训练数据的构建 读取数据集中的所有数据
# Mat1=R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\testDigits\d0.csv')
# Mat2=R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\testDigits\d1.csv')
# Mat3=R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\testDigits\d2.csv')
# Mat4=R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\testDigits\d3.csv')
# Mat5=R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\testDigits\d4.csv')
...
# trainX = totaldata[0:16800]
# train_Labels = totallable[0:16800]
#
# testX = totaldata[16801:]
# test_Labels = totallable[16801:]
#
# ##封装训练集数据：
...
# target_train_data_loader = DataLoader(input_train_data, batch_size=BATCH_SIZE, shuffle=True)
#
#
# #测试集数据
...
# target_test_data_loader = DataLoader(input_test_data, batch_size=BATCH_SIZE, shuffle=True)
...
def target_loader(BATCH_SIZE):
    ...
    # 训练数据的构建 读取数据集中的所有数据
    Mat1 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\target\data\0.csv')
    Mat2 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\target\data\1.csv')
    Mat3 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\target\data\2.csv')
    Mat4 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\target\data\3.csv')
    Mat5 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\target\data\4.csv')
    totalMat = np.concatenate((Mat1, Mat2, Mat3, Mat4, Mat5), axis=0)  # 垂直组合numpy
    # trainingMat=np.concatenate((trainX1,trainX2,trainX3),axis=0)#垂直组合numpy
    ...
    # #将读取的标签和向量数据存到列表中，并reshape他的维度为 总量 x 1 x 8 x 8
    totaldata = np.array(totalMat)  # 对数据进行预处理
    totaldata = totaldata.reshape((len(totaldata), 1, 40, 32))#1280=40 x 32)
    totallable = total_Labels

    # 划分训练集和测试集数据70%训练集，30%测试集
    trainX = totaldata[0:840]
    train_Labels = totallable[0:840]

    testX = totaldata[841:]
    test_Labels = totallable[841:]
    ...
    return target_train_data_loader, target_test_data_loader
