...
def source_loader(BATCH_SIZE):
    ...
    # 训练数据的构建 读取数据集中的所有数据
    Mat1 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\source\data\0.csv')
    Mat2 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\source\data\1.csv')
    Mat3 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\source\data\2.csv')
    Mat4 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\source\data\3.csv')
    Mat5 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\Dataset\original\source\data\4.csv')
    totalMat = np.concatenate((Mat1, Mat2, Mat3, Mat4, Mat5), axis=0)  # 垂直组合numpy
    # trainingMat=np.concatenate((trainX1,trainX2,trainX3),axis=0)#垂直组合numpy
    ...
    # 划分训练集和测试集数据70%训练集，30%测试集
    trainX = totaldata[0:7560]
    train_Labels = totallable[0:7560]

    testX = totaldata[7561:]
    test_Labels = totallable[7561:]
