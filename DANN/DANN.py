    ...
    with g.as_default():
        ...
        for i in range(num_batches):
            ...
            if verbose and i % (num_batches // 20) == 0:
                print('%s: %f, domain accuracy: %f, class accuracy: %f' % (train_loss_name, loss, da, pa))
        ...
        print('Source domain Acc: ', das)
        print('Source class Acc: ', pas)
        print('Target domain Acc: ', dat)
        print('Target class Acc: ', pat)
        print('***************************************\n')
