...
def Normal(data):#输入数据类型为列表
    ...
    Normalizer(copy=True, norm='l1')#选择l2范数
...
modelfilepath = r'C:\Users\86182\Desktop\LearnText\pytorch\test\practice\LSTM\Preprocess\Normal\train\mm_LSTM.test.pkl'
acc = 0
a = []
b = []
c = []
...
dataframe.to_csv(r"C:\Users\86182\Desktop\LearnText\pytorch\test\practice\LSTM\Preprocess\Normal\train\mm_epoch_acc_train_val_loss.csv",index=False,sep=',')

dataframe1 = pd.DataFrame({'steep':a1,'acc_step':b1,'train_step_loss':c1,'val_step_loss':d1})
dataframe1.to_csv(r"C:\Users\86182\Desktop\LearnText\pytorch\test\practice\LSTM\Preprocess\Normal\train\mm_step_acc_train_val_loss.csv",index=False,sep=',')
