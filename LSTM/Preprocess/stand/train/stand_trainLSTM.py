...
modelfilepath = r'C:\Users\86182\Desktop\LearnText\pytorch\test\practice\LSTM\Preprocess\stand\train\stand_LSTM.test.pkl'
acc = 0
a = []
b = []
c = []
...
dataframe.to_csv(r"C:\Users\86182\Desktop\LearnText\pytorch\test\practice\LSTM\Preprocess\stand\train\stand_epoch_acc_train_val_loss.csv",index=False,sep=',')

dataframe1 = pd.DataFrame({'steep':a1,'acc_step':b1,'train_step_loss':c1,'val_step_loss':d1})
dataframe1.to_csv(r"C:\Users\86182\Desktop\LearnText\pytorch\test\practice\LSTM\Preprocess\stand\train\stand_step_acc_train_val_loss.csv",index=False,sep=',')
