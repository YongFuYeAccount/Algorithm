...
def source_loader(BATCH_SIZE):
    ...
    # 训练数据的构建 读取数据集中的所有数据
    Mat1 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\trainDigits\train0.csv')
    Mat2 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\trainDigits\train1.csv')
    Mat3 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\trainDigits\train2.csv')
    Mat4 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\trainDigits\train3.csv')
    Mat5 = R_xcsv(r'C:\Users\86182\Desktop\Dataset\dataset2\trainDigits\train4.csv')
    totalMat = np.concatenate((Mat1, Mat2, Mat3, Mat4, Mat5), axis=0)  # 垂直组合numpy
    # trainingMat=np.concatenate((trainX1,trainX2,trainX3),axis=0)#垂直组合numpy
