...
class USPS(data.Dataset):
    ...
    url = "https://github.com/mingyuliutw/CoGAN/blob/master/cogan_pytorch/data/uspssample/usps_28x28.pkl"
    def __init__(self, root, train=True, transform=None, download=False):#True
        """Init USPS dataset."""
        # init params
    ...
    def load_samples(self):
        ...
        # data_set = pickle.load(filename, encoding="bytes")
        data_set = pickle.load(filename, encoding="latin1")
